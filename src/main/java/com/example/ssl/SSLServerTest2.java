...
public class SSLServerTest2 {
    ...
    public static void main(String[] args) {
        SSLServerTest2 server = new SSLServerTest2();
        server.init();
        server.start();
    }
    /**
    ...
    public void init() {
        try {
            ...
            ks.load(new FileInputStream("/Users/liuxiangyu/kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
            tks.load(new FileInputStream("/Users/liuxiangyu/tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
